  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Services / Process / Pricing — unchanged */}
        {/* (Your previous code — not repeating here to save space, but included below in full file if needed) */}
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            ...
            <Card className="p-6">
              <div className="flex items-baseline justify-between">
                ...
                <div className="text-2xl font-extrabold">$590</div>
              </div>
            ...
            <Card className="p-6 ring-2 ring-indigo-600">
              <div className="flex items-baseline justify-between">
                ...
                <div className="text-2xl font-extrabold">$1,390</div>
              </div>
            ...
            <Card className="p-6">
              <div className="flex items-baseline justify-between">
                ...
                <div className="text-2xl font-extrabold">$2,990</div>
              </div>
