    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50 text-zinc-900">
      ...
      <div className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 ring-1 ring-slate-900/10">
        <Section className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden gap-6 text-sm font-medium md:flex">
            ...
            <a className="hover:opacity-70" href="#process">
              Process
            </a>
            <a className="hover:opacity-70" href="#academy">
              Tax Academy
            </a>
            <a className="hover:opacity-70" href="#news">
              News
            </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button
              ...
              className="bg-indigo-600 text-white hover:shadow-md"
            >
              Book Now
            </Button>
            <Button
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white text-slate-900 ring-indigo-200 hover:shadow-sm"
            >
              Client Portal
            </Button>
          </div>
        ...
        >
          <div>
            ...
            <p className="mt-4 text-base text-slate-600">
              ...
              professionals. We handle the forms; you keep your focus.
            </p>
            ...
            <div className="mt-6 flex items-center gap-4 text-xs text-slate-500">
              <div className="flex items-center gap-1">
                <Star className="h-4 w-4 fill-black" /> 4.9/5 rated service
              </div>
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <ListItem icon={FileText} title="Individual & Family Returns">
                W-2 &amp; 1099 income, investments/RSUs, rentals (Schedule E), foreign
                accounts (FBAR/FATCA), ITIN.
              </ListItem>
      ...
      <Section id="services" className="py-14">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            Full-service preparation, smart planning, and proactive advice.
          </p>
        </div>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          <Card className="p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              LLC/Partnerships, S-Corp &amp; C-Corp returns, sales &amp; payroll tax,
              reasonable comp, quarterly planning.
            </p>
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-slate-600">
          ...
          <Card className="p-6">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Proactive strategies to reduce tax liability and plan cash flow year-round.
            </p>
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-slate-600">
      ...
      <Section id="process" className="py-14">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            A streamlined, three-step process that respects your time.
          </p>
        </div>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          {[
            {
              name: "Starter 1040",
              price: "$199+",
              points: ["W-2 income", "Standard deductions", "E-file & transcript check"],
              cta: "Book Starter",
            },
            {
              name: "Pro Individual",
              price: "$399+",
              points: ["Itemized or investments", "Rental, 1099, HSAs", "Multi-state supported"],
              cta: "Book Pro",
              highlight: true,
            },
            {
            ...
            <Card
              key={tier.name}
              className={`p-6 ${tier.highlight ? "ring-2 ring-black" : ""}`}
            >
      ...
      <Section id="academy" className="py-14">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            Hands-on training for aspiring tax pros. Choose a plan and get practical setup,
            software practice, and mentorship.
          </p>
        </div>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {/* PLAN 1 – $990 */}
          <Card className="p-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 inline-flex w-full items-center justify-center rounded-2xl bg-indigo-600 px-5 py-3 font-semibold text-white ring-1 ring-indigo-200 hover:shadow-md"
            >
              Enroll (Calendly)
            </a>
          </Card>
          ...
          <Card className="p-6">
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-600">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-indigo-600" />
                Schedule EA Exam / roadmap
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-indigo-600" />
                Mentorship 3 months after
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-indigo-600" />
                Video lessons access +6 months
              </li>
            </ul>
            <a
              href="https://calendly.com/finex101"
      ...
      <Section id="news" className="py-14">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            Deadlines, tax law changes, and FINEX announcements.
          </p>
        </div>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {[
            {
              ...
              blurb:
                "Top deductions, retirement contributions, and planning moves before Dec 31.",
              href: "#",
            },
            {
              date: "Oct 2025",
              ...
              blurb:
                "If you’re self-employed, the next estimated tax deadline is approaching.",
              href: "#",
            },
            {
              date: "Sep 2025",
              ...
              blurb:
                "A quick overview of credits that might reduce your business tax bill.",
              href: "#",
            },
          ].map((item) => (
            <Card key={item.title} className="p-6">
              ...
              <a
                href={item.href}
                className="mt-4 inline-flex items-center justify-center rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white ring-1 ring-indigo-200 hover:shadow-md"
              >
                Read more
              </a>
            </Card>
      ...
      <Section className="py-14">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            Real stories from individuals and business owners.
          </p>
        </div>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {[
            {
              text: "FINEX made my first year as an S-Corp painless. They explained reasonable comp, set up my payroll correctly, and found deductions I didn’t know about.",
              author: "— Sarah P., E-commerce Founder",
            },
            {
              text: "Clear pricing, fast communication, and they handled my multi-state filing without any surprises. Best tax experience I’ve had in years.",
              author: "— Daniel K., Software Consultant",
            },
            {
              text: "They reviewed a prior-year return and caught missed credits, then set up quarterly plan so I’m never behind again. Highly recommend.",
              author: "— Maya R., Real Estate Investor",
            },
          ].map((item, i) => (
      ...
      <Section id="faq" className="py-14">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-slate-600">
            Answers to common questions about our process and pricing.
          </p>
        </div>
        <div className="mx-auto mt-6 max-w-3xl">
          <FaqItem
            q="How fast can you complete my return?"
            a="Most individual returns are completed within 3–5 business days once we have all documents. Expedited options are available."
          />
          <FaqItem
            q="Do you work with clients outside New York?"
            a="Yes. We serve clients in all 50 states and can meet virtually via our secure portal."
          />
          <FaqItem
            q="What should I bring to our first meeting?"
            a="Photo ID, last year’s return, and all current-year tax documents (W-2, 1099, 1098, etc.). We’ll send a checklist."
          />
          <FaqItem
            q="How does pricing work?"
            a="We publish transparent base pricing and provide a firm quote after a quick document review. You only pay once you approve."
          />
        </div>
      </Section>
        ...
        <Card className="grid gap-8 p-6 md:grid-cols-2 md:p-10">
          <div>
            ...
            <div className="mt-6 space-y-3 text-sm">
              <a className="flex items-center gap-2" href="mailto:1@finex101.com">
                <Mail className="h-4 w-4" /> 1@finex101.com
              </a>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-2xl px-5 py-3 font-semibold shadow-sm ring-1 ring-indigo-200 bg-indigo-600 text-white hover:shadow-md"
                >
                  Book Now
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-2xl px-5 py-3 font-semibold shadow-sm ring-1 ring-black/10 bg-white text-slate-900 hover:shadow-sm"
                >
                  Client Portal
                </a>
              </div>
          ...
          <form className="grid gap-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid gap-2">
              ...
              <input
                className="rounded-xl border border-slate-900/10 px-3 py-2 outline-none focus:ring-2 focus:ring-black/20"
